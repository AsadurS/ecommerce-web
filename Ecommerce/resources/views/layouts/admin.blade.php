			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{url('/all-catagory')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Catagories</span></a></li>
						<li><a href="{{url('/add-catagory')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Catagories</span></a></li>
						...
						<li><a href="chart.html"><i class="icon-list-alt"></i><span class="hidden-tablet"> Link</span></a></li>
						<li><a href="typography.html"><i class="icon-font"></i><span class="hidden-tablet"> Shop Name</span></a></li>
						<li><a href="gallery.html"><i class="icon-picture"></i><span class="hidden-tablet"> Dalavry Man</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
...
@yield('catagory')
	...
	<script src="{{asset('/admin')}}/js/jquery.flot.resize.min.js"></script>
		...
		<script src="{{asset('/admin')}}/js/retina.js"></script>"{{asset('/admin')}}/
