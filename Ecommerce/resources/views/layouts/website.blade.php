              ...
              <?php   $all=DB::table('sliders')
                ...
                $active=1;
                  foreach ($all as $value){?>
                    <?php if ($active==1): ?>
							<div class="item active ">    <<?php //if($value->active==1){echo active';} ?>
                  <?php endif; ?>
                <?php if ($active>1): ?>
                  <div class="item  ">
                      <?php endif; ?>
								<div class="col-sm-6">
									...
									<h2>{{$value->slider_subHead}}</h2>
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
									<button type="button" class="btn btn-default get">Get it now</button>
								</div>
								<div class="col-sm-6">
                  <img src="{{asset('uplpads/slider/'.$value->slider_image)}}" alt="">

                	<img src="{{asset('/website')}}/images/home/pricing.png"  class="pricing" alt="" />
								</div>
							</div>
              ...
              <?php endforeach; ?>
                  ...
                  <?php endforeach; ?>
						...
						<div class="shipping text-center"><!--shipping-->
							<img src="{{asset('/website')}}/images/home/shipping.jpg" alt="" />
						</div><!--/shipping-->
