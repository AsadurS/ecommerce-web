		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<strong>error!</strong> password or name doesnot match.
					</div>
					@endif
					...
					{{ csrf_field() }}
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="name" id="username" type="text" placeholder="type username"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="pas" id="password" type="password" placeholder="type password"/>
							</div>
							<div class="clearfix"></div>
