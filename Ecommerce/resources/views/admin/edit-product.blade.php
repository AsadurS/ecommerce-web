...
@endif
          ...
          <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{url('/insert')}}">
            ...
            <div class="control-group">
              ...
              <input type="text" name="pro_name" value="{{$edit->pro_name}}">
              </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <?php foreach ($var as  $valu): ?>
                      <?php foreach ($selectedRole as $value): ?>
									<option value="{{$valu['id']}}" {{ $value['id'] ==$valu['id'] ? 'selected="selected"' : '' }} ?>
                 {{$valu->brand_name}}</option>
                   <?php endforeach; ?>
                    <?php endforeach; ?>
								  </select>
								</div>
