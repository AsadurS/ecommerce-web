...
<head>
    ...
    <title>{{ config('app.name', 'Home | E-Shopper') }}</title>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{asset('/website')}}/images/home/logo.png" alt="" /></a>
						</div>
	...
	<section>
		<div class="container">
            ...
            <div class="panel-group category-products" id="accordian"><!--category-productsr-->
              <?php
  $all=DB::table('tbl_categories')->where('category_status',1)->get();
               ?>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title"><a href="{{url('/cat_type/'.$value->category_id)}}">{{$value->category_name}}</a></h4>
                </div>
              </div>
              <?php endforeach; ?>
            ...
            <div class="brands_products"><!--brands_products-->
              ...
              <div class="brands-name">
                  <?php $brand=DB::table('brands')->where('brand_status',1)->get(); ?>
                  <?php foreach ($brand as  $value): ?>
                <ul class="nav nav-pills nav-stacked">
                  <li><a href="{{url('/brand_type/'.$value->id)}}"> <span class="pull-right">(50)</span><span style="font-weight: bold;">{{$value->brand_name}}</span></a></li>
                </ul>
                  <?php endforeach; ?>
              </div>
            </div><!--/brands_products-->
				...
				<div class="col-sm-9 padding-right">
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
              <?php foreach ($pro_details as $value): ?>
							<div class="view-product">
								<img src="{{asset('uplpads/'.$value->pro_image)}}" alt="" />
								<h3>ZOOM</h3>
							</div>
              <?php endforeach; ?>
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										<div class="item active">
										  <a href=""><img src="{{asset('website')}}/images/product-details/similar1.jpg" alt=""></a>
										  <a href=""><img src="{{asset('website')}}/images/product-details/similar2.jpg" alt=""></a>
										  <a href=""><img src="{{asset('website')}}/images/product-details/similar3.jpg" alt=""></a>
										</div>
										<div class="item">
										  <a href=""><img src="{{asset('website')}}/images/product-details/similar1.jpg" alt=""></a>
										  <a href=""><img src="{{asset('website')}}/images/product-details/similar2.jpg" alt=""></a>
...
<?php if (Session::has('success')): ?>
  .<div class="">
    <h3>message send successful</h3>
  </div>
<?php endif; ?>
<?php if (Session::has('success')): ?>
  .<div class="">
    <h3>message can not send</h3>
  </div>
<?php endif; ?>
									<form action="{{url('/messsage')}}" method="post">
                    {{csrf_field()}}
										<span>
											<input type="text" name="message_name"placeholder=""/>
											<input type="email"name="message_email" placeholder="Email Address"/>
										</span>
										<textarea name="message_text" ></textarea>
										<b>Rating: </b> <img src="{{asset('website')}}/images/product-details/rating.png" alt="" />
